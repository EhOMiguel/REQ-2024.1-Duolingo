...
- Grupo de [lições](#licao) que cobrem um tema ou tópico específico do idioma.
...
- Seção do aplicativo onde os [usuários](#usuario) podem encontrar respostas para perguntas frequentes e instruções.
